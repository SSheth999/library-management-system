...
<body>
    <div class="container">
        ...
        <main>
            ...
            <?php if ($validation && $validation->hasError('title') || $validation && $validation->hasError('author') || $validation && $validation->hasError('publication_year')): ?>
                <?php foreach ($validation->getErrors() as $error): ?>
                    <div class="alert alert-error"><?= esc($error) ?></div>
                <?php endforeach; ?>
            <?php endif; ?>

            <form action="<?= base_url('books/update/' . $book['id']) ?>" method="post" enctype="multipart/form-data" class="book-form">
                <?= csrf_field() ?>
                ...
                <div class="form-group">
                    ...
                    <small class="form-text">Maximum file size: 2MB. Supported formats: JPEG, PNG, GIF. Leave empty to keep current image.</small>
